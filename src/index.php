<?php
// Get the "FEATURE_DARK_MODE" value from the ConfigMap environment variable
...
<head>
    ...
    <title>CloudIkeme K8s Shopping Demo</title>
    ...
    <link href="css/dark-mode.css" rel="stylesheet" id="darkModeStylesheet">
    <?php endif; ?>
</head>
<body class="<?php echo $darkModeEnabled ? 'dark-mode' : ''; ?>">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <div class="dark-mode-toggle">
                                    <input type="checkbox" id="darkModeToggle" class="dark-mode-input" <?php echo $darkModeEnabled ? 'checked' : ''; ?>>
    ...
    <script>
        // Assuming you have a checkbox with id="darkModeToggle"
        ...
        darkModeToggle.addEventListener('change', () => {
            if (darkModeToggle.checked) {
                ...
                // Disable dark mode
                darkModeStylesheet.rel = 'stylesheet'; // Remove the stylesheet temporarily
                darkModeStylesheet.rel = 'alternate stylesheet'; // Then re-add it as an alternate stylesheet
            }
        });
    </script>
</body>
